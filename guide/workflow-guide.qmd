...
Claude Code is a **CLI tool** that runs on your computer with full access to your file system, terminal, and git. Here's what that enables:
...
| Multi-agent workflows | Specialized agents for proofreading, layout, pedagogy, code review |
| Quality gates | Automated scoring that blocks bad commits |
